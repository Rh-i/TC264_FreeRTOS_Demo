...
#define PROTOCOL_DEFAULT_SPEED 5 /**< 默认速度 cm/s */
  ...
  typedef enum
  {
    ...
    PROTOCOL_CMD_SET_POSITION = 0x03, /**< 设置相对位置 */
    PROTOCOL_CMD_QUERY_POS    = 0x04, /**< 查询当前位置 */
    PROTOCOL_CMD_SPEED_TIME   = 0x05, /**< 速度-时间模式 */
    PROTOCOL_CMD_DIST_TIME    = 0x06, /**< 距离-时间模式 */
    PROTOCOL_CMD_STOP         = 0x07, /**< 紧急停止 */
    PROTOCOL_CMD_MOTION_DONE  = 0x08, /**< 运动完成事件 */
  } ProtocolCmd;
  ...
  typedef enum
  {
    ...
    PROTOCOL_MODE_POSITION   = 0x02, /**< 位置模式 */
    PROTOCOL_MODE_SPEED_TIME = 0x03, /**< 速度-时间模式 */
    PROTOCOL_MODE_DIST_TIME  = 0x04, /**< 距离-时间模式 */
  } ProtocolMode;
